...
| processing <br> `cleaning.R` | Code used to clean the raw data and prepare the analytic dataset. | Cleaned data file found in the data folder. |
| analysis <br> `filename.R` | | Model files located in the models folder. |
